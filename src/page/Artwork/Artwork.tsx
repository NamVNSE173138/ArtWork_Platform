...
import ReportModal from "../../components/ReportForm/ReportForm";
...
export default function Artwork() {
  ...
  const fetchCommentList = async () => {
    await axios
      .get(`http://localhost:5000/comments/artwork/65b7d7d561e839c5836c00d8`)
      .then((res) => {
        ...
        <div className={styles.rightSection}>
            ...
            <div className={styles.info}>
              ...
              >
                ...
                <p style={{ minWidth: "fit-content" }}>
                  {nFormatter(artist.numOfFollower, 1)} Followers
                </p>
              </span>
            </div>
            <Button
          ...
          <div className={styles.commentSection}>
            {commentList.length > 0 ? (
                  ...
                  <List.Item className={styles.singleComment}>
                    <div>
                      ...
                      <div className={styles.commentInfo}>
                        ...
                        <Text
                          style={{ fontSize: "80%", alignSelf: "flex-start" }}
                        >
              ...
              <div>
                <Text>
                  There is no comment on this yet. Start sharing your thoughts
                  on this.
                </Text>
              </div>
            )}
          ...
          <div className={styles.buttonGroup}>
            ...
            <ReportModal artwork={artwork._id} />
          </div>
        </div>
      </div>
    </>
