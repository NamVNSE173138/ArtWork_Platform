...
import { approveNotification } from "../../api/notificate/notifcationAPI";
interface Artwork {
  _id: string;
  user: User;
  name: string;
    ...
    onSubmit: async (values) => {
      ...
      await axios
        ...
        .then((res) => {
          ...
          axios
            .post(`http://localhost:5000/artistRequests`, {
          ...
          axios
            .patch(
              `http://localhost:5000/userRequests/status/${userRequest._id}`,
              {
                status: true,
              }
            )
            .then((res) => {
              ...
              message.success(
                <Text>
                  Your request has been sent to {userRequest.user.nickname}.
                  Please stay alert to user's responses.
                </Text>,
                5
              );
              setTimeout(() => {
              ...
              approveNotification(userRequest.user._id);
              // console.log("userRequiest: ", userRequest);
    ...
    <>
      ...
      <Flex justify="center" align="center">
        ...
        <Card
          ...
          style={{ minWidth: "200px", maxWidth: "400px", minHeight: "200px" }}
        >
          <Image
            src={artistRequestForm.values.artwork.imageUrl}
            alt=""
            placeholder={true}
            preview={false}
          ...
          <form onSubmit={artistRequestForm.handleSubmit}>
            <Flex gap={10}>
              <Flex vertical>
                ...
                <input
                  type="text"
                  name="artwork.imageUrl"
                  placeholder="Enter artwork's URL here"
                  autoComplete="off"
                ...
                <Flex vertical>
                  <Text>
                    Tags <strong style={{ color: "red" }}>*</strong>
                  </Text>
                  <input
                    type="text"
                    name="artwork.tags"
